...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_DESTROY:
		...
		break;
	case WM_KEYDOWN:
		dev_app.keypress[wParam] = true;
		break;
	case WM_KEYUP:
		dev_app.keypress[wParam] = false;
		break;
	case WM_MOUSEMOVE:
		dev_app.mx = GET_X_LPARAM(lParam);
		dev_app.my = GET_Y_LPARAM(lParam);
		break;
	case WM_LBUTTONDOWN:
		dev_app.mouse[0] = true;
		break;
	case WM_LBUTTONUP:
		dev_app.mouse[0] = false;
		break;
	default:
